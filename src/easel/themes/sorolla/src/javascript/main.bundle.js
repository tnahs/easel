...
class AllContentItems {
    constructor() {
        ...
        this.FADE_IN_DELAY = 500;
        this.items = document.querySelectorAll(".content__item");
    }
    setup() {
...
class ImageContentItems {
    constructor() {
        ...
        this.PROXY_COLOR_ALPHA = this.style.getPropertyValue("--proxy-color--alpha");
...
class EmbeddedContentItems {
    constructor() {
        this.items = document.querySelectorAll(".content__item--embedded");
    }
    setup() {
    ...
    resizeEmbeddedContentItem(element) {
        /**
...
class Lightbox {
    constructor() {
         ...
         * --------------------------------------------------------------------- */
        this.CLASS_FADE_IN_OUT = "animation--fade-in-out";
        this.main = document.querySelector("#lightbox");
        this.buttonClose = this.main.querySelector(".lightbox__button--close");
        this.buttonPrev = this.main.querySelector(".lightbox__button--prev");
...
class LightboxGestureController extends LightboxController {
    ...
    setup() {
        this.lightbox.main.addEventListener("touchstart", (event) => {
            this.touchStart_x = event.changedTouches[0].screenX;
            this.touchStart_y = event.changedTouches[0].screenY;
        }, false);
        this.lightbox.main.addEventListener("touchend", (event) => {
