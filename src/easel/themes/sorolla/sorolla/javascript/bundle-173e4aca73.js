...
class AllContentItems {
    constructor() {
        ...
        this.FADE_DELAY = 500;
        this.containers = document.querySelectorAll(".content__container");
    }
    setup() {
...
class ImageContentItems {
    constructor() {
        this.items = document.querySelectorAll(".content--image");
    }
    setup() {
...
class EmbeddedContentItems {
    constructor() {
        this.items = document.querySelectorAll(".content--embedded");
    }
    setup() {
